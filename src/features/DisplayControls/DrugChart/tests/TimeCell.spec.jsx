...
describe("TimeCell", () => {
  ...
  it("should render icon on right side of cell if minutes is less than 30", async () => {
    const component = render(<TimeCell minutes="40" status="Administered" medicationNotes="Temp notes" />);
   await waitFor(() => { expect(component.getByTestId("right-icon")).toBeTruthy()}
    );
  });
